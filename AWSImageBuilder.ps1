...
WebClient.DownloadFile("https://github.com/aspyrmedia/Parsec-Cloud-Preparation-Tool/raw/master/PreInstall/TeamMachineSetup.ps1", "$ParsecDesktopTemp\TeamMachineSetup.ps1")
...
WebClient.DownloadFile("https://builds.parsecgaming.com/package/parsec-windows.exe", "$ParsecDesktopTemp\Apps\parsec-windows.exe")
# Parsec Virtual Display Driver
WebClient.DownloadFile("https://builds.parsec.app/vdd/parsec-vdd-0.37.0.0.exe", "$ParsecDesktopTemp\Apps\parsec-vdd.exe")
# NEEDED? GPUUpdaterTool
WebClient.DownloadFile("https://raw.githubusercontent.com/parsec-cloud/Cloud-GPU-Updater/master/GPUUpdaterTool.ps1", "$env:ProgramData\ParsecLoader\GPUUpdaterTool.ps1")
...
if ((gwmi win32_operatingsystem | % caption) -like '*Windows Server 2019*') {
  WebClient.DownloadFile("http://www.download.windowsupdate.com/msdownload/update/v3-19990518/cabpool/2060_8edb3031ef495d4e4247e51dcb11bef24d2c4da7.cab", "$ParsecDesktopTemp\Drivers\Xbox360_64Eng.cab")
